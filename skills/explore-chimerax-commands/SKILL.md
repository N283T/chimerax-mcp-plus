---
name: explore-chimerax-commands
description: ChimeraX command exploration and MCP operation reference
...
Reference for ChimeraX commands - for exploration and MCP operation.

## Index & Docs Paths

```bash
DOC_INDEX="${HOME}/.claude/skills/explore-chimerax/assets/chimerax-1.9.index.json"
DOC_ROOT="${HOME}/.claude/skills/explore-chimerax/assets/docs"
```

149 commands indexed. 13 tutorials. 16 API modules.
...
# Read the full doc
Read ${HOME}/.claude/skills/explore-chimerax/assets/docs/user/commands/color.html
```
...
```
Read ${HOME}/.claude/skills/explore-chimerax/assets/docs/<path-from-index>
```
...
Reference: `${HOME}/.claude/skills/explore-chimerax/assets/docs/user/commands/atomspec.html`
...
```
/explore-chimerax-commands                      # Interactive - describe what you want
/explore-chimerax-commands color protein        # Find coloring commands
/explore-chimerax-commands measure distance     # Find measurement commands
/explore-chimerax-commands open pdb             # File loading
```
